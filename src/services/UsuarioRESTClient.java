...
public class UsuarioRESTClient {
    ...
    public <T> T signIn_XML(Class<T> responseType, String emailUsr, String contraseniaUsr) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("{0}/{1}", new Object[]{emailUsr, contraseniaUsr}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T signIn_JSON(Class<T> responseType, String emailUsr, String contraseniaUsr) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("{0}/{1}", new Object[]{emailUsr, contraseniaUsr}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
